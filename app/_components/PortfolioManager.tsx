...
const initialForm: Form = { assetKey: "", symbol: "", name: "", assetType: "metal", side: "buy", quantity: "", price: "", fees: "0", currency: "INR", transactionDate: new Date().toISOString().slice(0, 10), notes: "" };
