...
export default function Page() {
  return (
    <InfoPage title="Privacy Policy" description="How GoldSilverPrices handles website usage information and push notification preferences.">
      ...
      <p>If you allow browser notifications, we store your push subscription details in our notification system so we can send two fixed editions on regular Indian trading days, including provider-backed gold, silver, platinum and copper information. Email requires a verified account and a separate opt-in. Disable all editions or individual delivery channels from the notification bell; every email includes an unsubscribe link.</p>
      <h2>What we store</h2>
