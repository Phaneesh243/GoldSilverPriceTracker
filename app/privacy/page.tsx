...
export default function Page() {
  return (
    <InfoPage title="Privacy Policy" description="How GoldSilverPrices handles website usage information and push notification preferences.">
      ...
      <p>If you allow browser notifications, we store your push subscription details in our notification system so we can send weekday gold and silver price updates and significant price-move alerts.</p>
      <h2>What we store</h2>
