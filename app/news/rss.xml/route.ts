...
export async function GET() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>GoldSilverPrices Market News</title><link>${siteUrl}/news</link><description>Latest source-attributed market, metals and investing news.</description><language>en-IN</language><lastBuildDate>${escapeXml(feed.fetchedAt)}</lastBuildDate>${items}</channel></rss>`;
